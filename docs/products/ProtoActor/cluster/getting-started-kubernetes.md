...
[Kubernetes provider](kubernetes-provider-net.md) is another implementation of `IClusterProvider` interface, the same as [Consul provider](consul-net.md). For more information you can check [Cluster providers section](cluster-providers-net.md).
